...
cp nh.dll ~/.local/share/Steam/steamapps/common/Titanfall2/R2Northstar/plugins/
```
...
The build produces `nh.dll`, which is automatically installed to:
```
~/.local/share/Steam/steamapps/common/Titanfall2/R2Northstar/plugins/
```

## Plugin Structure

- `src/nh.cc` - Main plugin logic
- `src/nh.hh` - Plugin header
- `src/PluginConfiguration.hh` - Plugin configuration
...
- The additions were completely generated by AI because I couldn't be bothered to do it lol
- You'll most likely need to change the file paths
- i use arch btw
